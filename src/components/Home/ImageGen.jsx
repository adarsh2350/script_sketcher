...
const ImageGen = () => {
  ...
  const handleImageGeneration = () => {
    ...
    if (panel[0].current.value.trim()===""){
      alert('Enter the prompt properly');
    }
    ...
    for (let i=0;i<10;i++){
      ...
      if (speech_bubble[i].current.value.trim()!==""){
        text = text + " with a speech bubble containing " + speech_bubble[i].current.value.trim(); 
      }
      query(text,images[i]);
    }
  };
  ...
  return (
    ...
    <div className='body'>
      ...
      {/* Title */}
      <div className="title">Script<span> Sketcher</span></div>

      {/* Panel cards */}
      <PanelCard ref1={panel1} ref2={speech_bubble1} placeholder1='Panel1'/>
      <PanelCard ref1={panel2} ref2={speech_bubble2} placeholder1='Panel2'/>
      <PanelCard ref1={panel3} ref2={speech_bubble3} placeholder1='Panel3'/>
      <PanelCard ref1={panel4} ref2={speech_bubble4} placeholder1='Panel4'/>
      <PanelCard ref1={panel5} ref2={speech_bubble5} placeholder1='Panel5'/>
      <PanelCard ref1={panel6} ref2={speech_bubble6} placeholder1='Panel6'/>
      <PanelCard ref1={panel7} ref2={speech_bubble7} placeholder1='Panel7'/>
      <PanelCard ref1={panel8} ref2={speech_bubble8} placeholder1='Panel8'/>
      <PanelCard ref1={panel9} ref2={speech_bubble9} placeholder1='Panel9'/>
      <PanelCard ref1={panel10} ref2={speech_bubble10} placeholder1='Panel10'/>

      {/* Generate button */}
      <div className="inputs">
        {(() => {
          if (loading) {
            return <div className="btn" onClick={handleImageGeneration}>Generating...</div>;
          } else {
       ...
       <div className='image_set'> 
        ...
        <ImageCards id="img4" imageURL={imageURL4} Prev="#img3" Next="#img5"/>
        <ImageCards id="img5" imageURL={imageURL5} Prev="#img4" Next="#img6"/>
        <ImageCards id="img6" imageURL={imageURL6} Prev="#img5" Next="#img7"/>
        <ImageCards id="img7" imageURL={imageURL7} Prev="#img6" Next="#img8"/>
        <ImageCards id="img8" imageURL={imageURL8} Prev="#img7" Next="#img9"/>
        <ImageCards id="img9" imageURL={imageURL9} Prev="#img8" Next="#img10"/>
